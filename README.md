...
- Comparative cloud model metadata and rank sanity checks should be cross-referenced against independent/current leaderboards before treating an unverified rank as authoritative:
  - BenchLM: `https://benchlm.ai`
  - Artificial Analysis: `https://artificialanalysis.ai/leaderboards/models`
  - LLM Stats: `https://llm-stats.com/leaderboards/llm-leaderboard` and `https://llm-stats.com/benchmarks`
  - WhatLLM: `https://whatllm.org/explore`
  - Vellum: `https://www.vellum.ai/llm-leaderboard`
  - LM Market Cap: `https://lmmarketcap.com`

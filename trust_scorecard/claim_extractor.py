...
_ALIAS_TABLE: dict[str, str] = {
    ...
    "swe-bench pro": "SWE-bench Pro",
    "swe bench multi": "SWE-bench Multilingual",
    "swe-bench multi": "SWE-bench Multilingual",
    ...
    "structured output error rate": "Structured Output Error Rate",
    "aa intelligence index": "AA Intelligence Index",
    "artificial analysis intelligence index": "AA Intelligence Index",
    "aa coding index": "AA Coding Index",
    "artificial analysis coding index": "AA Coding Index",
    "aa agentic index": "AA Agentic Index",
...
_BENCHMARK_NAMES = [
    ...
    r"SWE[- ]bench\s+Lite",
    r"SWE[- ]bench\s+Pro",
    r"SWE[- ]bench\s+(?:Multi|Multilingual)",
    r"SWE[- ]bench",
    r"SWE\s*bench",
    r"MMLU[- ]?ProX",
    r"MMLU(?:[-\s]+Pro)?",
    ...
    r"Toolathlon",
    r"TAU2[- ]?Bench",
    r"Terminal[- ]Bench(?:\s+2)?",
    r"MT[- ]?Bench",
    r"LAMBADA",
    r"Latency",
    r"Bias",
    r"Toxicity",
    r"Hallucination\s+Rate",
    r"Structured\s+Output\s+Error\s+Rate",
    r"(?:AA|Artificial\s+Analysis)\s+Intelligence\s+Index",
    r"(?:AA|Artificial\s+Analysis)\s+Coding\s+Index",
    r"(?:AA|Artificial\s+Analysis)\s+Agentic\s+Index",
    r"OCRBench",
    r"MathVision",
    r"OmniDocBench",
    r"VideoMME",

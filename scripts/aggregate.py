...
def generate_markdown_table(scores: list[dict]) -> str:
    ...
    lines.extend([
        ...
        "",
        "**Legend:**",
            "- Rank order: models with at least three use-case scores are ranked by weighted demonstrated capability, then trust score, evidence, capability metadata, scale/context, and name. Partial-data models follow, and models with no use-case scores are placed last.",
